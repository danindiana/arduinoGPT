...
const double samplingFrequency = 50; // Wave generation rate
...
void loop() {
  ...
  double randomFrequencyFactor = Entropy.random(600, 1800) / 1000.0;  // Scale for variation
  double randomAmplitudeFactor = Entropy.random(5, 20) / 10.0;      // Scale for variation
