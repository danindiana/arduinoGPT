...
#define SAMPLES 128          // Number of samples to take
...
void loop() {
  ...
  // Collect entropy-based random numbers as if they were analog data
  for (int i = 0; i < SAMPLES; i++) {
    ...
    delayMicroseconds(1000 / SAMPLING_FREQUENCY); // Delay to maintain the desired sampling frequency
  }
